...
const ChatGPT = ({
  ...
  messages: { text: string; id: number; sender: string }[];
}) => {
  return (
    <div
      className={`h-screen relative text-[#dcdbf6] bg-[#212121] flex flex-wrap flex-col ${
    ...
    >
      ...
      <div className="w-full px-4 h-[calc(100%-120px)] overflow-y-scroll scroll-area overflow-x-hidden">
        {messages.map((item, index) => (
          <Message index={index} content={item.text} sender={item.sender} key={item.id} />
        ))}
      </div>
